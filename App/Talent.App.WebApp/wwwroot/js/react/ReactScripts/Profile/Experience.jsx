...
export default class Experience extends React.Component {
    ...
    addNewExperience() {
        ...
        if (found === undefined) {
            ...
            data.push(this.state.experienceData)
    ...
    handleUpdateExperience(exp) {
        ...
        this.props.updateProfileData({ experienceData: data })
    }
    ...
    render() {
        const experienceList = this.props.experienceData
            ? this.props.experienceData.map(exp => <ExperienceDetail key={exp.start + exp.end} exp={exp} updateExperience={this.handleUpdateExperience} deleteExperience={this.handleDeleteExperience} />)
            : null
        return (
            <React.Fragment>
